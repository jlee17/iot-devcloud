...
parser.add_argument("-r", "--results_directory", default="results",
                    help="The folder to use when saving results and stats.  "
                    "A sub-folder will be created using the job id. ")
...
parser.add_argument("--learningrate",
		    ...
		    help="learningrate")
parser.add_argument("--weight_dice_loss",
		    type=float,
...
parser.add_argument("-ni", "--number_iter",
		    help="Number of iterations for each input", default=1, type=int)
parser.add_argument("--number_images",
                    help="Number of images to inference", default=80, type=int)
parser.add_argument("-of", "--output_frequency",
                    help="The frequency to output the results.  Set to number_iter to output every unique image."
                    "Set to a factor of number_iter to output every Nth image", default=1, type=int)
parser.add_argument("-si", "--start_index",
                    help="Starting image index to use", default=0, type=int)
...
parser.add_argument("-remove_training_layers", "--remove_training_layers", help="Remove training layers while inferencing",
                        default=False, action="store_true")
