...
for j in range(0,args.number_iter):
    ...
    for idx in range(0,len(indicies_validation),batch_size):
        ...
        for idy in range(batch_size):
            ...
            #print("Processed image " + str(indicies_validation[idx+idy]) + " in " + str(round(time_elapsed/batch_size*1000,2)) + " ms.")
            print("Processed image " + str(indicies_validation[idx+idy]) + " in " + str(round(time_elapsed/batch_size*1000,2)) + " ms." + " and total time " + str(round(time2_elapsed/batch_size*1000,2)))
