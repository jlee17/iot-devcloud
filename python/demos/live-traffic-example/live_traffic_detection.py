...
#     plugin.add_cpu_extension(args.cpu_extension)
  ...
  if args.output_dir:
    out_path = os.path.join(args.output_dir, job_id, out_file_name+'.mp4')
  ...
  #job_id = os.environ['PBS_JOBID']
  #job_id = "12345"
  inf_progress_file_path = os.path.join(args.output_dir, job_id, 'i_progress.txt')
  # Post Progress file update file
  ren_progress_file_path = os.path.join(args.output_dir, job_id, 'post_progress.txt')
